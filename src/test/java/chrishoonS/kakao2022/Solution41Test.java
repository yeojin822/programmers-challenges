...
class Solution41Test {
    ...
    @Test
    void solution() {
        Solution41 slt41 = new Solution41();
        assertArrayEquals(slt41.solution(new int[]{180, 5000, 10, 600},
        ...
        assertArrayEquals(slt41.solution(new int[]{120, 0, 60, 591},
                new String[] {"16:00 3961 IN","16:00 0202 IN","18:00 3961 OUT","18:00 0202 OUT","23:58 3961 IN"}),
                new int[]{0, 591});
        assertArrayEquals(slt41.solution(new int[]{1, 461, 1, 10},
